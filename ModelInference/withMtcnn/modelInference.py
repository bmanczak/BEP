...
#detector = MTCNN()
#img_path = "/Users/blazejmanczak/Desktop/modelTestPhotos/jaKamera.jpeg"
...
def applyPreprocessingInference(img_array, detector):
    ...
    for face in pipe.faces:
        if face.detected[0]['confidence'] >= 0.9:
...
#cv2.imwrite("withRectanglesParents1.jpg", cv2.cvtColor(abc, cv2.COLOR_RGB2BGR))
