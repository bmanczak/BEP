...
def detect_and_predict_mask(frame, faceNet, maskNet, version):
...
ap.add_argument("-m", "--model", type=str,
                default="/Users/blazejmanczak/Desktop/senetRafFromAcc64OrgDataAcc877",
...
while True:
    ...
    # face mask or not
    (locs, preds) = detect_and_predict_mask(frame, faceNet, maskNet, version)
